...
export const upDownBuffs: UpDownBuffType[] = [
    ...
    {up: Buff.BuffType.UP_GRANTSTATE, down: Buff.BuffType.DOWN_GRANTSTATE, description: "Effect Chance"},
    ...
    {up: Buff.BuffType.DOWN_TOLERANCE, down: Buff.BuffType.UP_TOLERANCE, description: "Effect Chance"},
    {
